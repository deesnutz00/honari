                          ...
                          ? () async {
                              ...
                              try {
                                ...
                                if (pickedCoverFile != null) {
                                  ...
                                  final coverPath =
                                      pickedCoverFile!.files.first.path;
                                  if (coverPath == null) {
                                    throw Exception(
                                      'Could not read cover image path',
                                    );
                                  }

                                  final coverFile = File(coverPath);
                                  final coverFileExt =
                                      pickedCoverFile!.files.first.extension ??
                                      'jpg';
                                ...
                                print(
                                  '🔗 Public URL for book file: $publicUrl',
                                );
                                ...
                                final bookId = await _bookService.createBook(
                                  ...
                                  bookFileUrl:
                                      signedUrl, // Use signed URL for reading
                                  userId: user.id,
                                );
